...
const STATUSES = ["All", "Active", "Low Stock", "Inactive"];
const ITEMS_PER_PAGE = 8;
const API_URL = "http://localhost:5000/api/products"; // Apni backend URL check kar lein
...
function AddProductModal({ onClose, onAdd }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-slate-100 border border-[#0F3A53]/20 rounded-2xl shadow-2xl p-6 w-full max-w-md mx-4 text-[#0F3A53]">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-bold">Add New Product</h2>
          <button
            onClick={onClose}
            className="text-gray-500 hover:text-[#0F3A53] transition text-xl leading-none"
          >
            ✕
          </button>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-white border border-[#0F3A53]/20 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0F3A53]/30"
            />
          </div>
        ...
        <div className="flex gap-3 mt-6">
          <button
            onClick={onClose}
            className="flex-1 border border-[#0F3A53]/20 text-gray-500 rounded-xl py-2.5 text-sm font-semibold hover:bg-white transition"
          >
            Cancel
          </button>
          <button
            onClick={handleSubmit}
            className="flex-1 bg-[#0F3A53] text-white rounded-xl py-2.5 text-sm font-semibold transition shadow-lg"
          >
            Add Product
          </button>
        </div>
      ...
      <div className="bg-white border border-[#0F3A53]/10 rounded-2xl px-5 py-4 mb-4 flex flex-wrap gap-4 items-end shadow-sm">
        <div className="flex flex-col gap-1.5">
          ...
          <select
            ...
            className="bg-slate-100 border border-[#0F3A53]/20 rounded-xl px-3 py-2 text-sm focus:outline-none"
          >
            {CATEGORIES.map((c) => (
              <option key={c} value={c}>
                {c}
        ...
        <div className="flex flex-col gap-1.5 flex-1 min-w-48">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-slate-100 border border-[#0F3A53]/20 rounded-xl pl-9 pr-4 py-2 text-sm focus:outline-none"
            />
          </div>
        </div>
      </div>
                      ...
                      <td className="px-4 py-3.5">
                        <div className="flex items-center gap-3">
                          <img
                            src={product.image}
                            alt=""
                            className="w-10 h-10 rounded-xl object-cover bg-slate-100 border border-[#0F3A53]/10"
                          />
                      ...
                      <td className="px-4 py-3.5 text-center">
                        <div className="flex justify-center gap-2">
                          <button
                            ...
                            className="text-xs px-3 py-1.5 rounded-lg border border-[#dc2626]/30 text-[#dc2626] hover:bg-red-50 font-medium"
                          >
                            Delete
                          </button>
                        </div>
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <div className="flex gap-1">
          <button
            disabled={page === 1}
            onClick={() => setPage((p) => p - 1)}
            className="px-3 py-1.5 text-sm rounded-xl border border-[#0F3A53]/20 disabled:opacity-30"
          >
            Prev
          </button>
          <button
