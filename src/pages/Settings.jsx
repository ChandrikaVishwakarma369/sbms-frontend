    ...
    <div className="space-y-6 animate-in fade-in">
      <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <CustomInput label="Current" type="password" placeholder="••••••••" />
          <CustomInput label="New" type="password" placeholder="••••••••" />
          <CustomInput label="Confirm" type="password" placeholder="••••••••" />
        </div>
        <div className="flex items-center justify-between mt-5 pt-4 border-t border-gray-50">
          <p className="text-[10px] text-gray-400 italic">
            Last changed: 3 months ago
          </p>
          <button className="bg-[#1f4e63] text-white px-4 py-2 rounded-lg font-bold text-[11px] shadow hover:bg-[#2a6681] transition-all">
            Update Password
          </button>
        </div>
      </div>
      ...
      <div className="flex gap-6 items-center p-5 bg-gray-50 rounded-2xl border border-gray-100 border-dashed">
        ...
        <div className="flex-1">
          ...
          <p className="text-[10px] text-gray-400">
            PNG, JPG up to 2MB (Invoices & Reports)
          </p>
        </div>
  ...
  return (
    <div className="w-full px-4 py-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-6 bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <button className="bg-[#1f4e63] text-white px-5 py-2.5 rounded-xl font-bold shadow-md hover:scale-105 transition-all text-xs flex items-center gap-2">
          <Save size={14} /> Save Changes
        </button>
      </div>

      {/* 2. Top Navigation Bar (Replacing Sidebar) */}
...
const CustomInput = ({ label, icon, ...props }) => (
  <div className="space-y-1 group">
    ...
    <div className="relative">
      {icon && (
        <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#1f4e63] transition-colors">
          {icon}
        </div>
      )}
      <input
